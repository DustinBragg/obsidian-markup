...
export default class MarkupPlugin extends Plugin {
	...
	// Colored Text
	{
		...
		this.addCommand({
		    ...
		    name: "Color selected text (Color " + (ColorIndex + 1) + ": " + this.Settings.Colors[ColorIndex] + ")",
		    editorCallback: () => {
	...
	// Highlighted Text
	{
		...
		this.addCommand({
		    ...
		    name: "Highlight selected text (Highlight " + (HighlightIndex + 1) + ": " + this.Settings.HighlightColors[HighlightIndex] + ")",
		    editorCallback: () => {
